...
while counter <= to_process.to_i
  ...
  if name == "Drake Cula" or name == "Tu Fang"
    ...
    elsif (age.to_i != Time.now.year - birth_year.to_i || age.to_i != (Time.now.year - birth_year.to_i)-1) && (garlic_response.downcase == "no") && (insurance_choice.downcase == "no")
      ...
      decision = " are probably a vampire"
    elsif (age.to_i == Time.now.year - birth_year.to_i || age.to_i == (Time.now.year - birth_year.to_i)-1) && (garlic_response.downcase == "yes" || insurance_choice.downcase == "yes")
